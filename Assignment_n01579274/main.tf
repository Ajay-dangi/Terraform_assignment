...
module "rgroup" {
  source          = "./modules/rgroup-N01579274"
  rgroup-name     = "N01579274-RG"
...
module "network" {
  source          = "./modules/network-N01579274"
...
module "common" {
  source          = "./modules/common-N01579274"
...
module "vmlinux" {
  source            = "./modules/vmlinux-N01579274"
  nb_count          = "3"
  linux-vm-name     = "vmlinux-N01579274"
  rgroup-name       = module.rgroup.az-rgroup-name.name
  rgroup-location   = module.rgroup.az-rgroup-location.location
...
module "vmwindows" {
  source         = "./modules/windows-N01579274"
  windows_name   = {
    N01579274-vm1 = "Standard_B1s"
    N01579274-vm2 = "Standard_B1ms"
  }
  win_nb_count     = "1"
  subnet_id        = module.network.azurerm_subnet_name.id
  rgroup-name      = module.rgroup.az-rgroup-name.name
...
module "datadisk" {
  source                   = "./modules/datadisk-N01579274"
  rgroup-name              = module.rgroup.az-rgroup-name.name
  rgroup-location          = module.rgroup.az-rgroup-location.location
...
module "loadbalancer" {
  source           = "./modules/loadbalancer-N01579274"
  rgroup-name      = module.rgroup.az-rgroup-name.name
  rgroup-location  = module.rgroup.az-rgroup-location.location
...
module "database" {
  source      = "./modules/database-N01579274"
  rgroup-name     = module.rgroup.az-rgroup-name.name
  rgroup-location = module.rgroup.az-rgroup-location.location
  depends_on = [
    module.rgroup
